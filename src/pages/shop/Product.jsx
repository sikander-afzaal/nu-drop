          ...
          <Fade triggerOnce direction="right">
            <div className="flex justify-start items-start flex-col gap-5">
              ...
              <p className="text-white font-bold text-base sm:text-lg md:text-xl 2xl:text-2xl font-mont">
                ...
                Psilocybin mushrooms. There are plenty of reasons to take a
                whole heap of psilocybin mush-rooms but the most compelling one
                is that it's a lot of fun. A deep psychedelic trip can also
                ctalyse deep reflective iner work. If you do want to chal-lenge
                ingrained patterns of thought, or you require some rigorous
                inner reflection- psilocybin can help you with this!
              </p>
              <p className="text-white font-bold text-base sm:text-lg md:text-xl 2xl:text-2xl font-mont">
                The Avery Albino is a highly potent cubensis hybrid famous for
                its long lasting body high and ghostly white colouration. This
                intense but soothing strain remains a bit of a mystery. It isn't
                clear who is responsible for the Avery Albino strain ans seems
              ...
              <div className="flex mt-3 justify-start sm:w-auto w-full items-center sm:items-start flex-col gap-3">
                <p className="text-white font-bold font-arial text-4xl">
                  $80.00
                </p>

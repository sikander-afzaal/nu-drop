      ...
      <div className="contain flex-col justify-start items-center gap-8">
        <div className="flex justify-start items-center flex-col text-center gap-5">
          ...
          >
            ...
            mushroom range in an array of strains for your own choosing.. allow
            yourself to voyage on an adventure of unique personal discovery.
            Whether you choose to microdose or to macrodose the choice is
            yours.. Make sure to read through each description to carefully pick
            a strain for your own personal consumption!
          </p>
          <p
            className={
              "font-arial text-center font-bold text-base sm:text-lg text-white"
          ...
          >
            ...
            can be used for both microdosing effects, as well as for macrodosing
            so if you arent too keen on mushrooms for reasons we cannot fathom
            then you can decide on what may work for you best.
          </p>
          <p
            className={
              "font-arial text-center font-bold text-base sm:text-lg text-white"
